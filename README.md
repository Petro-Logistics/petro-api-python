...
## Troubleshooting
- ### Error 1
  - _**Message:**_ ```requests.exceptions.HTTPError: 401 Client Error: Unauthorized for url: https://secure.petro-logistics.com/api/v2/aggregatemovementsdata.php```
  - _**Solution:**_ Update firewall settings to trust the PL domain

- ### Error 2
  - _**Message:**_ ```SSLError: HTTPSConnectionPool(host=‘secure.petro-logistics.com’, port=443): Max retries exceeded with url: /api/v2/aggregatemovementsdata.php (Caused by SSLError(SSLError(“bad handshake: Error([(‘SSL routines’, ‘tls_process_server_certificate’, ‘certificate verify failed’)])“)))```
...
- ### Error 3
  - _**Message:**_ ```fatal: unable to access ’https://github.com/Petro-Logistics/petro-api-python/’: schannel: next InitializeSecurityContext failed: Unknown error (0x80092012) - The revocation function was unable to check revocation for the certificate.```
